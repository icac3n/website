        ...
        <nav className="bg-red-800 border-gray-200">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                {menuOpen && <div className={"w-full md:block md:w-auto"}>
                    <ul className="flex flex-col gap-2 font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:flex-row md:gap-5 md:mt-0 md:border-0">
                        ...
                        <li onClick={dropToggle} className={"cursor-pointer relative"}>
                             ...
                             </span>
                            {
                                dropOpen &&
                                <div id="dropNav"
                                     className={"md:absolute lg:absolute mt-3 z-10 font-normal bg-amber-100 divide-y divide-amber-800 rounded-lg shadow md:w-44 w-full"}>
