                ...
                <div tw="flex flex-col w-full h-full items-center justify-center bg-white">
                    <div tw="bg-red-800 h-full items-center justify-center flex w-full">
                        <div tw="flex flex-col justify-center items-center text-white">
                            ...
                            <p tw="font-bold text-4xl text-center">International Conference on Recent Trends in </p>
                            <p tw="font-bold text-4xl -mt-4 text-center">Intelligent Computing and Communication - ICRTICC</p>
                            <p tw="font-bold text-3xl -mt-1">2024</p>
