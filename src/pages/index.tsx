      ...
      <main className={"mx-8"}>
        ...
        >
          ...
          >
            ...
            >
              <RiArticleLine
                className={"hidden self-start text-xl text-red-800 lg:block"}
              />
              <div className={"text-red-800"}>
                <p
                  className={"text font-semibold"}
                  itemProp={"conference-record-number"}
                >
            ...
            <div className={"mt-4 flex items-center justify-center"}>
              <Link
                ...
                className={
                  "block h-fit w-fit cursor-pointer rounded-lg bg-red-700 px-4 py-2 text-white md:hidden "
                }
              >
                Submit&nbsp;Paper
              </Link>
          ...
          <div className={"mx-2 grid grid-cols-1 md:mx-auto lg:grid-cols-3"}>
            <div className={"col-span-full lg:col-span-2 lg:mr-10"}>
              ...
              <p className={"text-justify"}>
                ...
                together top researchers, scientists, engineers, and scholars
                from around the world to share their latest research findings
                and experiences in computing, communication control, and
                networking. Featuring keynote speeches, technical sessions, and
                workshops, the conference covers a wide range of topics such as
                cloud computing, AI, wireless communication systems, IoT, and
                cybersecurity.
              </p>
              <hr className="my-8 h-px border-0 bg-gray-200 dark:bg-gray-700" />
              <h2
              ...
              <p className={"text-justify"}>
                ...
                practical skills and creating ‘Global Professionals’ for more
                than 18 years. Founded by Smt. Shakuntala Educational and
                Welfare Society, Galgotia Educational Institutions is currently
                led by Mr. Suneel Galgotia, Chairman and a resolute visionary.
                Galgotias College of Engineering & Technology is placed among
                the best in professional education in Dr. APJ Abdul Kalam
                Technical University (Formerly U.P. Technical University). It
                has achieved top positions in MBA, MCA and B.Tech. finals and
                has a record of 100% placements with the best corporate houses.
                It has also been ranked amongst the top engineering colleges in
                India by DATAQUEST NASSCOM survey and OUTLOOK-C For College
                Survey.
              </p>
              <hr className="my-8 h-px border-0 bg-gray-200 dark:bg-gray-700" />
              <h2
              ...
              <p className={"whitespace-pre-wrap text-justify"}>
                The Computer Science & Engineering Department at GCET offers a
                UG program in Computer Science and Engineering. It has
                experienced faculty members, well-equipped labs, and promotes
                industry-institute collaboration. The department focuses on
                research areas such as Computer Networks, Database Systems,
                Multimedia, Image Processing, Software Engineering, Computer
                Architecture, Information System – Security and Data Mining.
                Students get opportunities to work on state-of-the-art projects,
                gain real-world experience, and have good alumni and industry
                relations. Galgotias Computer Science graduates get recruited by
